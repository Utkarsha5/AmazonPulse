...
INTENT_BUNDLES: dict[str, dict] = {
    "gym": {
        ...
        "cart_items": [
            {
                "sku": "B0WHEY1KG",
                "title": "Optimum Nutrition Whey Protein 1 kg",
                "quantity": 1,
                "price_inr": 3299,
            ...
            {
                "sku": "B0WATER1L",
                "title": "Electrolyte Water 1 L (Pack of 6)",
                "quantity": 1,
                "price_inr": 180,
            ...
            {
                "sku": "B0GRANOLA",
                "title": "MuscleBlaze High Protein Granola 400 g",
                "quantity": 1,
                "price_inr": 299,
    ...
    "bake": {
        ...
        "cart_items": [
            {
                "sku": "B0FLOUR500",
                "title": "Organic All-Purpose Flour 500 g",
                "quantity": 1,
                "price_inr": 89,
            ...
            {
                "sku": "B0SUGAR1KG",
                "title": "Refined Sugar 1 kg",
                "quantity": 1,
                "price_inr": 52,
                "bundle_reason": "GNN: sweetener",
            },
            {
                "sku": "B0EGGS12",
            ...
            {
                "sku": "B0COCOA200",
                "title": "Dutch Process Cocoa Powder 200 g",
                "quantity": 1,
                "price_inr": 245,
    ...
    "movie": {
        ...
        "cart_items": [
            {
                "sku": "B0POPCORNM",
                "title": "Butter Popcorn Microwavable 3-pack",
                "quantity": 1,
                "price_inr": 149,
            ...
            {
                "sku": "B0CHIPS150",
                "title": "Classic Salted Potato Chips 150 g",
                "quantity": 2,
                "price_inr": 40,
            ...
            {
                "sku": "B0NACHOS",
                "title": "Cheese Nachos with Salsa Dip 175 g",
                "quantity": 1,
                "price_inr": 99,
                "bundle_reason": "GNN: binge-watch pairing",
            },
        ],
        "community_top_carts": [
            {
    ...
    "fever": {
        ...
        "cart_items": [
            {
                "sku": "B0PARA500",
                "title": "Paracetamol 500 mg (15 tablets)",
                "quantity": 1,
                "price_inr": 35,
                "bundle_reason": "GNN: fever reducer",
            },
            {
                "sku": "B0ORS",
                "title": "Electral ORS Powder (5 sachets)",
                "quantity": 1,
                "price_inr": 62,
            ...
            {
                "sku": "B0SOUP",
                "title": "Instant Chicken Soup Mix 55 g",
                "quantity": 2,
                "price_inr": 45,
            ...
            {
                "sku": "B0VAPOR",
                "title": "Vicks Vaporub 25 ml",
                "quantity": 1,
                "price_inr": 125,
                "bundle_reason": "GNN: congestion relief",
            },
        ],
        "community_top_carts": [
            {
    ...
    "emergency_essentials": {
        ...
        "cart_items": [
            ...
            {
                "sku": "B0BREAD",
                "title": "Whole Wheat Bread 400 g",
                "quantity": 1,
                "price_inr": 45,
                "bundle_reason": "Fallback: pantry base",
            },
            {
                "sku": "B0EGGS6",
                "title": "Farm Fresh Eggs (6 pack)",
                "quantity": 1,
                "price_inr": 54,
            ...
            {
                "sku": "B0WATER2L",
                "title": "Packaged Drinking Water 2 L",
                "quantity": 2,
                "price_inr": 35,
                "bundle_reason": "Fallback: hydration",
            },
        ],
        "community_top_carts": [
            {
